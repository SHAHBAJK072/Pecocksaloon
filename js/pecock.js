...
for(b=0; b<sub.length; b++){
    ...
    document.querySelectorAll(".mains")[b].style.transform="translateY(100px)"
};
...
var tl = gsap.timeline();
  ...
  tl.from(".heeroimg" , {x:200, opacity:0, duration:.8})
gsap.from(".aimg",{x:-200, opacity:0, duration:1, scrollTrigger:{trigger:".aimg", scroller:"body", start:"top 100  " , end:"500",scrub:2}})
gsap.from(".abouttext",{x:200, opacity:0, duration:1, scrollTrigger:{trigger:".aimg", scroller:"body" ,start:"top 100  ", end:"500", scrub:2}})
gsap.from(".featuretext",{y:-100, opacity:0, duration:1, scrollTrigger:{trigger:".featuretext", scroller:"body" ,start:"top 100 " , scrub:2}})
...
.to("#main .mains",{y:-100, opacity:0,stagger:1});
